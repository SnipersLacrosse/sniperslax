...
Class WPOA {
	...
	private $settings = array(
		...
		'wpoa_sportid_api_enabled' => 0,								// 0, 1
		'wpoa_sportid_api_id' => '',									// any string
		'wpoa_sportid_api_secret' => '',								// any string
	...
	*/
	...
	function wpoa_push_login_messages() {
		if (!isset( $_SESSION['WPOA'] )) { return; }
		if (!isset( $_SESSION['WPOA']['RESULT'] )) { return; }
	...
	function wpoa_login_buttons($icon_set, $button_prefix) {
		...
		$html .= $this->wpoa_login_button("sportid", "SPORT iD", $atts);
